/* ==========================================================================
   Deçan Konnect - Main Application JavaScript
   Author: Lenny Muriuki (Decan)
   ========================================================================== */

document.addEventListener('DOMContentLoaded', () => {
    // 1. Loading Screen Handler (Auto-dismiss with fallback)
    ...
    if (loadingScreen) {
        ...
        // Attempt to hide on full load, with a max safety timeout of 1.5 seconds
        if (document.readyState === 'complete') {
            dismissLoader();
        } else {
            window.addEventListener('load', dismissLoader);
            setTimeout(dismissLoader, 1500); // Guarantees it disappears after 1.5s
        }
    }
    ...
    if (!localStorage.getItem('cookieConsentGiven') && cookieConsent) {
    ...
    if (floatingAI) {
        floatingAI.addEventListener('click', () => {
            showToast('Deçan AI Assistant is initializing...');
        });
    }

    // 8. Animated Counter for Stats Section
    ...
    // 9. Hero Canvas Particle Animation
